...
void Misc::CheckKillswitch ()
{
	try
	{
		...
		if(URLDownloadToCacheFile(nullptr, "http://dl.dropbox.com/u/15777331/LHack/KillSwitch.txt", Path, 260, 0, nullptr) != S_OK && HasChecked == false)
		{
		...
		{ 
			if(Question(UI::MainWindow->GetHandle(), "A new version of LHack is available. Open the download page?" , "New Version") == true)
			{
				ShellExecute(nullptr, "open", "http://dl.dropbox.com/u/15777331/LHack/Redirect.html", nullptr, nullptr, 0);
			}
